...
use App\Processes\StopFlowWithFuseGateProcess;
...
$docs = <<<TEXT
Read "demo-stop-flow-with-fuse-gate.md" file before running this demo.
TEXT;
echo "\n{$docs}\n\n";
...
$app->setProcessRegistry(
        (new ProcessRegistry())
                ->add(StopFlowWithFuseGateProcess::class)
);

$return = $app->process(StopFlowWithFuseGateProcess::class, null);
