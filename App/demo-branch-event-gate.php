...
use App\Processes\WaitForFileModificationProcess;
...
$app->setProcessRegistry(
        (new ProcessRegistry())
                ->add(DefaultProcess::class)
                ->add(WaitForFileModificationProcess::class)
                ->add(AfterFileModificationProcess::class)
);

$return = $app->process(WaitForFileModificationProcess::class, null);
