...
use App\Processes\BranchWithAndGateProcess;
...
$docs = <<<TEXT
Read "demo-branch-and-gate.md" file before running this demo.
TEXT;
echo "\n{$docs}\n\n";
...
$app->setProcessRegistry(
        (new ProcessRegistry())
                ...
                ->add(BranchWithAndGateProcess::class)
                ->add(ParallelProcess_C::class)
);

$return = $app->process(BranchWithAndGateProcess::class, null);
