...
use App\Processes\StateChangeWithSaveAndUndoProcess;
...
$app->setProcessRegistry(
        (new ProcessRegistry())
                ->add(StateChangeWithSaveAndUndoProcess::class)
);

$return = $app->process(StateChangeWithSaveAndUndoProcess::class, null);
